        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 py-2">
                    <div class="card">
                        <img src="@/assets/images/trivia-listimg.jpg" class="card-img-top">
                        <div class="card-body">
                            <p class="card-text main-text"><i class="bi bi-patch-question-fill"></i> : Testing for Wipe Out Naija</p>
                            <p class="card-text card-text-after"><i class="bi bi-credit-card-fill"></i> : Free</p>
                            <router-link to="/trivia-content" class="routers"><a class="btn-view">Play Quiz</a></router-link>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 py-2">
