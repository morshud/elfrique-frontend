                     ...
                     <form name="form" @submit.prevent="createVote">
                         ...
                         <div class="row">
                                ...
                                <div class="col-lg-12 mt-2">
                                    ...
                                    <input v-model="votecontent.title" class="input" type="text" placeholder="Enter event title" required>
                                </div>
                                ...
                                <div v-if="voteContent.type == 'paid' " class="col-lg-12 mt-4">
                                    ...
                                    <input v-model="votecontent.votingfee" class="input" type="number" required>
                                </div>
                                <!--Event Image-->
                                <div class="col-lg-12 mt-4">
                                    <label for="event image">Upload Contest Image</label>
                                    <input ref="file" class="input" type="file" accept=".jpg, .jpeg, .png, .jfif" v-on:change="handleFileUpload()" required>
  ...
  created() {
    ...
    methods:{
          createVote(){
            ...
            formData.append('paymentgateway', this.voteContent.preferredPaymentGateway);
            formData.append('votelimit', this.voteContent.dailyVoteLimit);
            formData.append(' contestantProfileView', this.voteContent. contestantProfileView);
            formData.append('categories', this.voteContent.awardCategory);
            formData.append('acceptCryptoPayments', this.voteContent.acceptCryptoPayments);

            if (this.voteContent.category == 'peageant') {
                VoteService.createVote(formData).then(response => {
            ...
            if (this.voteContent.category == 'award') {
                VoteService.createAward(formData).then(response => {
