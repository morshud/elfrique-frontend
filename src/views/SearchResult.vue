    ...
    <section class="searchContent">
      <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="card mb-3">
              <div class="row g-0">
                <div class="col-md-5">
                    <a href="#">
                        <div class="imgHouse">
                            <img :src="con.image" class="img-fluid rounded-start" draggable="false">
                        </div>
                    </a>
                </div>
                <div class="col-md-7">
                  <div class="card-body">
                    <a href="#"><h5 class="card-title">{{con.title}}</h5></a>
          ...
          <div v-if="searchContent.length==0 && loading==false" class="col-md-10 mb-1">
            <div class="card mb-3">
              <div class="row g-0">
                <div class="col-md-5">
                ...
                <div class="col-md-7">
                  <div class="card-body">
                    <p class="card-text">No {{$route.params.product}} for this keyword</p>
                  </div>
                </div>
              </div>
            </div>
...
<script>
    ...
    export default {
      ...
      data() {
        ...
        created() {
            SearchService.getSearchContent(this.product,this.keyword).then(response => {
                this.loading = false;
