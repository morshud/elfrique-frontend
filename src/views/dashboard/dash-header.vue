      ...
      <ul class="sidebar-nav" id="sidebar-nav">
          ...
          >
            ...
            <li>
              <router-link to="/organiser/search-vote" class="routers"
                ...
                ><span>Search For Vote</span></router-link
              >
            </li>
          </ul>
        </li>
        ...
        <li class="nav-item">
          ...
          >
            ...
            <li>
              <router-link
                to="/organiser/trivia-sales-analytics"
                class="routers"
                ><a
                  ><i class="bi bi-circle"></i><span>Sales Analytics</span></a
                ></router-link
          ...
          >
            ...
            <li>
              <router-link to="/organiser/view-vendor-service" class="routers"
                ><a
                  ><i class="bi bi-circle"></i
                  ><span>View All Vendor Service</span></a
                ></router-link
              >
            </li>
            <li>
              <router-link to="/organiser/edit-vendor-service" class="routers"
                ><a
                  ><i class="bi bi-circle"></i
                  ><span>Edit Vendor Service </span></a
                ></router-link
              >
            </li>
            <li>
              <router-link to="/organiser/bidders-vendor" class="routers"
                ><a
                  ><i class="bi bi-circle"></i
                  ><span>View All Bidders Project </span></a
                ></router-link
              >
            </li>
            <li>
            ...
            <li>
              <router-link to="/organiser/advert-listing" class="routers"
                ><a
                  ><i class="bi bi-circle"></i
                  ><span> View All Advert Listing</span></a
                ></router-link
              >
            </li>
            <li>
